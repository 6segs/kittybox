...
function initLibrary()
    ...
    local gameConfigFolder = folderName .. "/" .. GetName.Name
    ...
    function library:LoadConfig(file)
        local str = readfile(gameConfigFolder .. "/" .. file .. ".txt")
    ...
    function library:SaveConfig(name)
        ...
        writefile(gameConfigFolder .. "/" .. name .. ".txt", "return " .. configstr)
    end
    ...
    function library:Window(opts)
        ...
        local uiname = utility.create("TextLabel", {
            ZIndex = 3,
        ...
        function windowTypes:Rename(value)
            uiname.Text = value
        end
